...
/**
 * Exercises {@link DictionaryService#toResponse} directly against hand-built
 * fixtures, rather than the network-calling {@code fetch} method - no real
 * HTTP call is made, so this doesn't depend on the external API being up.
 */
